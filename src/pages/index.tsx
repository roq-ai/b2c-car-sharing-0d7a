  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing: Empowering Individual Customers to Book Nearby Cars with Ease, Managed Efficiently by Operations Staff from Centralized Dashboards"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing: Empowering Individual Customers to Book Nearby Cars with Ease, Managed Efficiently by Operations Staff from Centralized Dashboards`}
            </Text>
            <Box
